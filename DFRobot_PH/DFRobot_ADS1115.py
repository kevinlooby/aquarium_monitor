...
ADS1115_REG_CONFIG_CQUE_1CONV = 0x00  # Assert ALERT/RDY after one conversion
...
class ADS1115:
    def __init__(self):
        ...
        self.channel = 0
        self.addr_G = ADS1115_IIC_ADDRESS1
    ...
    def set_single(self):
        ...
        bus.write_i2c_block_data(self.addr_G, ADS1115_REG_POINTER_CONFIG, CONFIG_REG)
    ...
    def set_differential(self):
        ...
        if self.channel == 0:
            CONFIG_REG = [
                ADS1115_REG_CONFIG_OS_SINGLE | ADS1115_REG_CONFIG_MUX_DIFF_0_1 | self.gain | ADS1115_REG_CONFIG_MODE_CONTIN,
                ADS1115_REG_CONFIG_DR_128SPS | ADS1115_REG_CONFIG_CQUE_NONE]
        elif self.channel == 1:
            CONFIG_REG = [
                ADS1115_REG_CONFIG_OS_SINGLE | ADS1115_REG_CONFIG_MUX_DIFF_0_3 | self.gain | ADS1115_REG_CONFIG_MODE_CONTIN,
                ADS1115_REG_CONFIG_DR_128SPS | ADS1115_REG_CONFIG_CQUE_NONE]
        elif self.channel == 2:
            CONFIG_REG = [
                ADS1115_REG_CONFIG_OS_SINGLE | ADS1115_REG_CONFIG_MUX_DIFF_1_3 | self.gain | ADS1115_REG_CONFIG_MODE_CONTIN,
                ADS1115_REG_CONFIG_DR_128SPS | ADS1115_REG_CONFIG_CQUE_NONE]
        elif self.channel == 3:
            CONFIG_REG = [
                ADS1115_REG_CONFIG_OS_SINGLE | ADS1115_REG_CONFIG_MUX_DIFF_2_3 | self.gain | ADS1115_REG_CONFIG_MODE_CONTIN,
                ADS1115_REG_CONFIG_DR_128SPS | ADS1115_REG_CONFIG_CQUE_NONE]
    ...
    def read_value(self):
        ...
        data = bus.read_i2c_block_data(self.addr_G, ADS1115_REG_POINTER_CONVERT, 2)
